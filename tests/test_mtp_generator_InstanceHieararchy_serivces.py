...
service1 = Service_obj('service_test1', '')


class Test_InstanceHierarchy_Services(object):  # test some functions of mtp generator
    ...
    def test_add_service_to_InstanceHierarchy(self):
        ...
        service_name1 = self.mtp_generator.InstanceHierarchy_Service.find('InternalElement').get('Name')
        assert service_name1 == 'service_test1'
    ...
    def test_add_components_to_service(self):
        ...
        service_ie = self.mtp_generator.InstanceHierarchy_Service.find('InternalElement')
        assert len(service_ie.findall('InternalElement')) == 2
    ...
    def test_add_components_to_procedure(self):
        ...
        # in this test case, a procedure should have one report value and one procedure parameter
        procedure_ie = self.mtp_generator.InstanceHierarchy_Service.findall('InternalElement/InternalElement')[1]
        assert len(procedure_ie.findall('InternalElement')) == 2
...
if __name__ == '__main__':
    pytest.main(['test_mtp_generator_InstanceHieararchy_serivces.py', '-s'])
