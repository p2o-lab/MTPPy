...
class ControlElementsDIntServParam:
    ...
    def _attach_opcua_nodes(self):
        ...
        variables = {
            'VExt': {'type': ua.VariantType.Int32, 'init_value': 0, 'callback': self.set_VExt, 'writable': True},
            'VOp': {'type': ua.VariantType.Int32, 'init_value': 0, 'callback': self.set_VOp, 'writable': True},
            'VInt': {'type': ua.VariantType.Int32, 'init_value': 0, 'callback': self.set_VInt, 'writable': True},
            'VReq': {'type': ua.VariantType.Int32, 'init_value': 0, 'callback': None, 'writable': False},
            'VOut': {'type': ua.VariantType.Int32, 'init_value': 0, 'callback': None, 'writable': False},
            'VFbk': {'type': ua.VariantType.Int32, 'init_value': 0, 'callback': None, 'writable': False},
            'VSclMin': {'type': ua.VariantType.Int32, 'init_value': self.v_scl_min, 'callback': None, 'writable': False},
            'VSclMax': {'type': ua.VariantType.Int32, 'init_value': self.v_scl_max, 'callback': None, 'writable': False},
            'VUnit': {'type': ua.VariantType.UInt32, 'init_value': self.v_unit, 'callback': None, 'writable': False},
            'VMin': {'type': ua.VariantType.Int32, 'init_value': self.v_min, 'callback': None, 'writable': False},
            'VMax': {'type': ua.VariantType.Int32, 'init_value': self.v_max, 'callback': None, 'writable': False},
